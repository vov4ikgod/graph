import { css, boundaries, toCoords, line, isOver, computeYRatio, computeXRatio } from './utills.js';
...
export function sliderChart(root, data, DPI_WIDTH) {
    ...
    root.addEventListener('mousedown', mousdown);
    ...
    // const xRatio = DPI_WIDTH / (data.columns[0].length - 5);
